...
permalink: /juju/developer-debugging/
---
...
environment](./authors-hook-environment.html).
  ...
  ![Image showing tmux debug hooks session](/docs-demo/media/juju/authors-hook-debug-1.png)
...
![Image showing byobu and tmux ](/docs-demo/media/juju/tmux-annotation.png)
