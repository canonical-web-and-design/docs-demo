...
![Amazon accounts page with Security Creds](/docs-demo/media/juju/getting_started-aws_security.png)
...
![Amazon Access Credentials page showing key values](/docs-demo/media/juju/getting_started-aws_keys.png)
.
