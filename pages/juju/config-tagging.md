...
![named instances in Amazon](/docs-demo/media/juju/config-tagging-named.png)
...and tags like this:
![tagged instances in Amazon](/docs-demo/media/juju/config-tagging-tagged.png)
...
```
![user tagged instances in Amazon](/docs-demo/media/juju/config-tagging-user.png)
