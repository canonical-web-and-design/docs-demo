...
permalink: /juju/authors-charm-metadata/
---
...
![Juju Charm Store metadata Listing](/docs-demo/media/juju/authors-metadata-display.png)

[Storage](./developer-storage) can also be declared in a charm's metadata,
as such:
