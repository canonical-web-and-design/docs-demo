...
permalink: /snapcraft/snapcraft-syntax/
---
...
* `parts` (yaml subsection)
  ...
  [parts section](snapcraft-parts) for some more concrete examples.
    * `plugin` (string)
...
Review the [metadata section](metadata) for some more explicit examples on
